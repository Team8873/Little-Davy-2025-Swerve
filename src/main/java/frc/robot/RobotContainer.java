...
public class RobotContainer {
    ...
    private void configureBindings() {
        ...
        operator.a().debounce(0.5).whileTrue(new ElevatorPresetCommand(elevator, arm, 'a', false).withTimeout(5));
        operator.b().debounce(0.5).whileTrue(new ElevatorPresetCommand(elevator, arm, 'b', false).withTimeout(5));
        operator.x().debounce(0.5).whileTrue(new ElevatorPresetCommand(elevator, arm, 'x', false).withTimeout(5));
        operator.y().debounce(0.5).whileTrue(new ElevatorPresetCommand(elevator, arm, 'y', false).withTimeout(5));
        operator.pov(270).debounce(0.5).whileTrue(new ElevatorPresetCommand(elevator, arm, 't', false).withTimeout(5));
        operator.pov(0).debounce(0.5).whileTrue(new ElevatorPresetCommand(elevator, arm, 'h', true).withTimeout(5));
