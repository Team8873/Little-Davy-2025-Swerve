...
public class Constants {
    ...
    public static class PresetConstants {
        ...
        public static final double lvl2ElevatorGroundPos = 0.47;
        public static final double lvl3ElevatorGroundPos = 1.67;
        ...
        public static final double elevatorAlgaeGroundPos = 1.55;
        public static final double armAlgaeGroundPos = 0.18;
    ...
    public static class Vision {
        ...
        private static final double mcamPitch = Units.degreesToRadians(30.0);
        public static final Transform3d mRobotToCam =
                new Transform3d(new Translation3d(0.5, 0.0, 0.5), new Rotation3d(0, -mcamPitch, 0));
